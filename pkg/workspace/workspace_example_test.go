...
func ExampleSubsystem_Conventions() {
	_ = any((*Subsystem).Conventions)
	core.Println("Subsystem.Conventions")
	// Output: Subsystem.Conventions
}

func ExampleSubsystem_Root() {
	_ = any((*Subsystem).Root)
	core.Println("Subsystem.Root")
	// Output: Subsystem.Root
}
